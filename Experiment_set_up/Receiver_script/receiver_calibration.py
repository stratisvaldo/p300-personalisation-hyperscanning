...
3) Start the receiver - python lsl_receiver_calibration.py --eeg_name UnicornRecorderLSLStream --marker_name P300Markers --output data/calib_play_01.npz --print_markers

.npz file
- eeg_samples: (n_samples, n_channels) 
