...
3) Start the receiver -python Experiment_set_up/Receiver_script/receiver_calibration.py --eeg_name Unicorn --marker_name P300Markers --output data_calib/calib_play_01.npz --print_markers
